...
PlasmaExtras.ExpandableListItem {
    ...
    required property int scheduleType
    required property bool destAvailable
    required property var lastCompleteBackup
    ...
    subtitle: {
        ...
        return line1 + (line1 ? "\n" : "") + i18ndc("kup", "%1 is formatted relative date", "Last saved: %1", Format.formatRelativeDate(lastCompleteBackup, Locale.LongFormat));
    }
    ...
    QQC2.Action {
        id: pruneAction
        enabled: type === Kup.Enums.BackupType.BupType && destAvailable
